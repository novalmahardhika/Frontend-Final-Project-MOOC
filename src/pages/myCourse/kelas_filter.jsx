      ...
      <div className="flex justify-between relative bg-secondary font-poppins font-medium right-0 h-full w-screen overflow-hidden">
        ...
        <div className="flex  flex-col  items-center w-screen">
          <div className="flex space-x-5 ">
            ...
            <Button className="w-[280px] h-[40px] bg-white text-black hover:bg-active">
              Kelas Premium
            </Button>
            <Button className="w-[230px] h-[40px] bg-primary text-white hover:bg-active">
              Kelas Gratis
            </Button>
          </div>
          ...
          <div className="flex ">
            <div className="grid grid-cols-1 grid-rows-1">
              <div>
                <p className="flex items-start mr-[200px] mt-3">
                  Menampilkan hasil
              ...
              <div className="grid grid-cols-1 grid-rows-2">
                <div className="">
                  <div className="w-[350px] h-[225px] flex flex-col  mt-5 bg-white rounded-md">
