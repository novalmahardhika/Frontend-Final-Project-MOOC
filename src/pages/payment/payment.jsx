            ...
            <TabsContent value="Bank Transfer">
              {activeTab === "Bank Transfer" && (
                <Card title="Bank Transfer">
                  <div className="mb-6">
                    <p className="text-lg font-semibold mb-2 ml-4">
                      Informasi Transfer Bank
                    </p>
                    <div className="bg-gradient-to-r from-primary to-secondary p-6 rounded-md shadow-lg">
              ...
              {activeTab === "Credit Card" && (
                ...
                >
                  ...
                  <ol style={{ listStyleType: "none" }} className="space-y-6">
                    <FormItem label="Card Number" className="border-b">
                      <p>Card number</p>
                      <input
                        id="cardNumber"
        ...
        <div className="w-2/5">
          <div className="font-poppins">
            <Card className="w-full p-2">
              <CardHeader className="font-bold text-primary text-center">
                Pembayaran Kelas
              </CardHeader>
              <CardContent>
              ...
              <CardFooter>
                <Button
                  className="bg-red-500 w-full h-12 rounded-full hover:bg-primary"
