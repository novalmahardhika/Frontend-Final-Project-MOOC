    ...
    <div className="flex w-screen h-screen font-poppins">
        ...
        <div className="items-center w-4/5 mx-auto md:w-1/2">
          <div className="max-w-md p-8 mx-auto space-y-6">
            ...
            <form className="space-y-6">
              ...
              <div className="flex flex-wrap items-center justify-center pt-2 space-x-2 text-sm">
      ...
      {isModalVisible && (
        <div className="fixed top-0 bottom-0 left-0 right-0 flex items-center justify-center h-20">
          <div className="p-4 text-white rounded-md shadow-md bg-success">Login berhasil! Mengalihkan ke halaman Beranda...</div>
        </div>
      )}
      {isModalError && (
        <div className="fixed top-0 bottom-0 left-0 right-0 flex items-center justify-center h-20">
          <div className="p-4 text-white rounded-md shadow-md bg-destructive">Login gagal silahkan coba kembali...</div>
        </div>
      )}
    </div>
  );
